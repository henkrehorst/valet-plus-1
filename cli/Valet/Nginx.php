...
class Nginx
{
    ...
    public function installConfiguration()
    {
        ...
        $this->files->putAsUser(
            $this->brew->getBrewPrefix().static::NGINX_CONF,
    ...
    public function installServer()
    {
        ...
        $this->files->ensureDirExists($this->brew->getBrewPrefix().'/etc/nginx/valet');

        $this->files->putAsUser(
            $this->brew->getBrewPrefix().'/etc/nginx/valet/valet.conf',
            str_replace(
        ...
        $this->files->putAsUser(
            $this->brew->getBrewPrefix().'/etc/nginx/fastcgi_params',
    ...
    {
        $this->cli->quietly(
            'sudo nginx -c '.$this->brew->getBrewPrefix().self::NGINX_CONF.' -t',
